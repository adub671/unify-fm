...
class StationForm(FlaskForm):
    ...
    stream_url = StringField('Stream URL', validators=[
                             DataRequired(), URL(message="Please Enter A Valid URL")])
    image_url = StringField('Image URL', validators=[
                            DataRequired(), URL(message="Please Enter A Valid URL")])
    chat_url = StringField('Chat URL', validators=[
                           Optional(), URL(message="Please Enter A Valid URL")])
    website_url = StringField('Website URL', validators=[
                              Optional(), URL(message="Please Enter A Valid URL")])
    calendar_url = StringField('Calendar URL', validators=[
                               Optional(), URL(message="Please Enter A Valid URL")])
    additional_link_1 = StringField(
        'Additional Link 1', validators=[Optional(), URL(message="Please Enter A Valid URL")])
    additional_link_2 = StringField(
        'Additional Link 2', validators=[Optional(), URL(message="Please Enter A Valid URL")])
    additional_link_3 = StringField(
        'Additional Link 3', validators=[Optional(), URL(message="Please Enter A Valid URL")])
    ...
    now_playing_url = StringField(
        'Now Playing URL', validators=[Optional(), URL(message="Please Enter A Valid URL")])
