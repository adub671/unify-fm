...
def seed_radio_stations():
    ...
    ifmdisco = RadioStation(
        ...
        chat_url="",
        now_playing_url="https://feed.tunein.com/profiles/s99619/nowPlaying?token=eyJwIjpmYWxzZSwidCI6IjIwMjItMTItMDhUMDA6MjU6MTQuOTEyODAyNFoifQ&itemToken=BgQEAAIAAgABAAEACwsAAQQAAA&formats=mp3,aac,ogg,flash,html,hls,wma&serial=d67f0997-537a-453c-979e-f22eaa1104fd&partnerId=RadioTime&version=5.3301&itemUrlScheme=secure&reqAttempt=1",
        calendar_url="",
        additional_link_1="",
        additional_label_1="",
        additional_link_2="",
    ...
    ifmcbs = RadioStation(
        ...
        chat_url="",
        now_playing_url="https://feed.tunein.com/profiles/s99620/nowPlaying?token=eyJwIjpmYWxzZSwidCI6IjIwMjItMTItMDhUMDA6MzE6MjAuMTk5ODM5OFoifQ&itemToken=BgQEAAMAAwABAAEACwsAAQQAAA&formats=mp3,aac,ogg,flash,html,hls,wma&serial=d67f0997-537a-453c-979e-f22eaa1104fd&partnerId=RadioTime&version=5.3301&itemUrlScheme=secure&reqAttempt=1",
        calendar_url="",
        additional_link_1="",
        additional_label_1="",
        additional_link_2="",
